...
students = ['Jesus' , 'David', 'Matt']

def manage_students():
    first_student = 'Josh'
    last_student = 'Jessica'
    students[1] = first_student
    students[-1] = last_student
    return students
...
foods = ('Pizza' , 'Burger', 'Tacos', 'Pasta' , 'Steak')
def combine_foods():
    meal = ''
    for food in foods:
        meal += food
...
home_town = {'city' : 'Maracaibo' , 'state' : 'Zulia' , 'population' : 500}
def hometown_info():
